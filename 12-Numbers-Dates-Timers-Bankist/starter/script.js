...
const startLogOutTimer = function () {
  const tick = function () {
    //Convert time to min and second
...
/* const num = 15691272105.42;

const options = {
  style: 'unit', // 'currency'//'percent'
  unit: 'mile-per-hour', //'celsius'//thousands of unit
  currency: 'EUR', //(must set the currency if style is currency)
  // useGrouping: false,
};

console.log('US:', new Intl.NumberFormat('en-US', options).format(num));

console.log('Croatia:', new Intl.NumberFormat('hr-HR', options).format(num));
...
/* 
//SetTimeout -- run a function after a certain amount of time
/* //Asyn JS
...
//SetInterval -- run a function over and over agin(every ... seconds/mins/..)
